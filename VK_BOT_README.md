...
- потом отдельно добавить обработку `message_new`, кнопок и ответов
...
1. добавить обработку `message_new`
2. завести отправку ответов через VK API
3. связать VK-диалог с логикой броней
4. при необходимости сделать отдельный сервисный слой `vk_handlers.py`
